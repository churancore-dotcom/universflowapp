...
const TrendingNowSection = memo(({ enabled = true }: Props) => {
  ...
  // Only the real fastest-rising chart is allowed here. No keyword-search
  // fallback, personalization, or random order may impersonate a live chart.
    ...
    <section className="mb-2 pt-4">
      <div className="flex items-end justify-between mb-3 px-1">
        <div>
          ...
          <p className="text-[11px] text-muted-foreground/55 font-semibold mt-0.5">Fastest-rising official tracks</p>
        </div>
      </div>
