  ...
  return (
    <div className="max-w-3xl mx-auto px-5 pt-5 pb-12">
      ...
      <section className="grid grid-cols-2 gap-3 mt-4">
        ...
        {/* No fabricated amount here: the payout rate lives server-side and the
            real, verified figure is computed on the Earnings page. */}
        <QuickAction to="/artist/studio/earnings" icon={<IndianRupee className="w-4 h-4" />} label="Earnings" />
